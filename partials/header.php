...
<aside class="sidebar">
  <div class="logo">
    <img src="assets/images/logo1.jpg" height="100px" width="100px">
  </div>
  <div class="nav">
    <div class="<?= $current_page === 'index.php' ? 'active' : '' ?>">
      <a href="../index.php"><span class="material-symbols-outlined">grid_view</span>Dashboard</a>
    </div>

    <div class="<?= $current_page === 'exercise_plans.php' ? 'active' : '' ?>">
      <a href="../exercise_plans.php"><span class="material-symbols-outlined">exercise</span>Exercise Plans</a>
    </div>

    <div class="<?= $current_page === 'diet_plans.php' ? 'active' : '' ?>">
      <a href="../diet_plans.php"><span class="material-symbols-outlined">assignment</span> Diet Plans</a>
    </div>

    <div class="<?= $current_page === 'calorie_input.php' ? 'active' : '' ?>">
      <a href="../calorie_input.php"><span class="material-symbols-outlined">cycle</span> Calorie Counter</a>
    </div>

    <div class="<?= $current_page === 'bmi_input.php' ? 'active' : '' ?>">
      <a href="../bmi_input.php"><span class="material-symbols-outlined">body_fat</span>BMI</a>
    </div>
  </div>
</aside>
        ...
        <?php if ($user_id): ?>
          ...
          <i class="fas fa-caret-down"></i></span>
            <ul class="dropdown" id="userDropdown">
              <li><a href="../admin/profile.php"><i class="fas fa-user"></i> Settings</a></li>
