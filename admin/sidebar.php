  ...
  <aside class="sidebar">
    ...
    <div class="nav">
      <div class="<?= $current_page === 'profile.php' ? 'active' : '' ?>">
        <a href="profile.php"><span class="material-symbols-outlined">grid_view</span>Profile</a>
      </div>
    <div class="<?= $current_page === 'index.php' ? 'active' : '' ?>">
      ...
      <div class="<?= $current_page === 'upload_image.php' ? 'active' : '' ?>">
        <a href="upload_image.php"><span class="material-symbols-outlined">upload_file</span>Upload image</a>
      </div>
